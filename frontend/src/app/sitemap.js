...
export default async function sitemap() {
  const staticPages = [
    ...
    { url: `${BASE_URL}/kitchen-remodeling`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.9 },
    { url: `${BASE_URL}/bathroom-remodeling`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.9 },
    { url: `${BASE_URL}/cabinets`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.9 },
    { url: `${BASE_URL}/countertops`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.9 },
    { url: `${BASE_URL}/flooring`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.9 },
