...
export default async function sitemap() {
  const staticPages = [
    ...
    { url: `${BASE_URL}/shaker-style-cabinets`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.7 },
    ...
    { url: `${BASE_URL}/traditional-style-cabinets`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.7 },
    { url: `${BASE_URL}/rustic-style-cabinets`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.7 },
    { url: `${BASE_URL}/modern-style-cabinets`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.7 },
    { url: `${BASE_URL}/renovations`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.8 },
    // Bathroom
    ...
    // Other
    { url: `${BASE_URL}/review-us`, lastModified: new Date(), changeFrequency: 'yearly', priority: 0.5 },
