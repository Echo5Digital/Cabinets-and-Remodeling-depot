  ...
  return (
    <>
        ...
        <div className="relative z-10 flex-1 flex items-center py-14 sm:py-16 md:py-20">
          <div className="container-custom w-full">
            <div className="max-w-lg lg:max-w-xl xl:max-w-2xl lg:pl-6 xl:pl-10">
              ...
              >
                <span className="block text-white text-3xl sm:text-4xl md:text-[3.1rem] lg:text-[3.5rem]">The Timeless Luxury</span>
                <span className="block text-gold text-2xl sm:text-[1.7rem] md:text-[2.5rem] lg:text-[2.8rem] mt-1.5 leading-[1.1]">of Marble</span>
              </motion.h1>
        ...
        <div className="container-custom max-w-4xl">
          <FadeIn>
            <p className="text-gray-600 text-base sm:text-lg leading-[1.82]">
              Celebrated for its graceful veining and unmistakable elegance, marble countertops bring a sense of sophistication to every space. From soft, understated patterns to bold natural movement, each slab is uniquely crafted by nature, creating interiors that are both refined and enduring. Marble remains a distinguished choice for homeowners who appreciate classic beauty and exceptional craftsmanship.
            </p>
          </FadeIn>
        </div>
      </section>
      ...
      <section className="relative py-20 md:py-28 overflow-hidden">
        <div className="absolute inset-0">
          <Image src="/countertops_2.jpg" alt="Marble countertop background" fill className="object-cover object-center" sizes="100vw" />
        ...
        <div className="relative z-10 container-custom max-w-3xl text-center px-4">
          <FadeIn>
            ...
            <p className="font-playfair text-gray-900 text-2xl sm:text-3xl md:text-4xl font-extrabold leading-tight mb-6">
              Every project is custom fabricated and professionally installed to preserve the natural elegance and distinctive character of every marble slab.
            </p>
            <Link
              href="/contact"
