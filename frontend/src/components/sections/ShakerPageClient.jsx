...
const IMAGES = [
  ...
  { src: '/shaker-cabinets-1.webp', alt: 'Shaker cabinet kitchen installation' },
  { src: '/shaker-cabinets-2.webp', alt: 'Shaker cabinets in kitchen' },
...
export function ShakerPageClient() {
  ...
  return (
    <>
      ...
      <section className="relative flex flex-col min-h-[55vh] md:min-h-[65vh] overflow-hidden">
        <div className="absolute inset-0">
          <Image
            ...
            alt="Shaker kitchen cabinets hero"
            fill
            priority
        ...
        <div className="relative z-10 flex-1 flex items-center py-14 sm:py-16 md:py-20">
          <div className="container-custom w-full">
            <div className="max-w-lg lg:max-w-xl xl:max-w-2xl lg:pl-6 xl:pl-10">
              ...
              >
                <span className="block text-white text-3xl sm:text-4xl md:text-[3.1rem] lg:text-[3.5rem]">Timeless Simplicity with</span>
                <span className="block text-gold text-2xl sm:text-[1.7rem] md:text-[2.5rem] lg:text-[2.8rem] mt-1.5 leading-[1.1]">Shaker Cabinets</span>
              </motion.h1>
        ...
        <div className="container-custom max-w-4xl">
          <FadeIn>
            <p className="text-gray-600 text-base sm:text-lg leading-[1.82]">
              Renowned for their clean lines and understated elegance, Shaker cabinets have remained a favorite for generations. Their distinctive recessed-panel design offers remarkable versatility, blending effortlessly with modern, transitional, farmhouse, and traditional kitchens alike. Available in a wide range of finishes and colors, Shaker cabinetry creates a refined foundation that enhances both everyday living and sophisticated interior design.
            </p>
          </FadeIn>
        </div>
      </section>
      ...
      <section className="relative py-20 md:py-28 overflow-hidden">
        <div className="absolute inset-0">
          <Image src="/cabinet_img.webp" alt="Shaker cabinets background" fill className="object-cover object-center" sizes="100vw" />
        ...
        <div className="relative z-10 container-custom max-w-3xl text-center px-4">
          <FadeIn>
            ...
            <p className="font-playfair text-gray-900 text-2xl sm:text-3xl md:text-4xl font-extrabold leading-tight mb-6">
              Every cabinet is thoughtfully crafted and professionally installed to deliver exceptional quality, timeless style, and a flawless fit for your kitchen.
            </p>
            <Link
              href="/contact"
