...
const IMAGES = [
  { src: '/granite.webp',           alt: 'Granite countertop slab close-up' },
...
export function GranitePageClient() {
  ...
  return (
    <>
        ...
        <div className="relative z-10 flex-1 flex items-center py-14 sm:py-16 md:py-20">
          <div className="container-custom w-full">
            <div className="max-w-lg lg:max-w-xl xl:max-w-2xl lg:pl-6 xl:pl-10">
              ...
              >
                <span className="block text-white text-3xl sm:text-4xl md:text-[3.1rem] lg:text-[3.5rem]">Timeless Elegance in</span>
                <span className="block text-gold text-2xl sm:text-[1.7rem] md:text-[2.5rem] lg:text-[2.8rem] mt-1.5 leading-[1.1]">Natural Granite</span>
              </motion.h1>
        ...
        <div className="container-custom max-w-4xl">
          <FadeIn>
            <p className="text-gray-600 text-base sm:text-lg leading-[1.82]">
              Formed by nature and refined through expert craftsmanship, granite countertops bring unmatched character to every space. Our curated collection highlights rich colors, striking mineral patterns, and distinctive veining — ensuring each slab is truly one of a kind. Combining exceptional durability with enduring beauty, granite is a sophisticated choice for kitchens, bathrooms, and spaces designed to make a lasting impression.
            </p>
          </FadeIn>
        </div>
      </section>
      ...
      <section className="relative py-20 md:py-28 overflow-hidden">
        <div className="absolute inset-0">
          <Image src="/countertops_3.jpg" alt="Granite countertop background" fill className="object-cover object-center" sizes="100vw" />
        ...
        <div className="relative z-10 container-custom max-w-3xl text-center px-4">
          <FadeIn>
            ...
            <p className="font-playfair text-gray-900 text-2xl sm:text-3xl md:text-4xl font-extrabold leading-tight mb-6">
              Every project is custom fabricated and professionally installed to showcase the unique beauty of natural granite with precision and lasting quality.
            </p>
            <Link
              href="/contact"
