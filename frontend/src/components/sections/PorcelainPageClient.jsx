...
export function PorcelainPageClient() {
  ...
  return (
    <>
        ...
        <div className="relative z-10 flex-1 flex items-center py-14 sm:py-16 md:py-20">
          <div className="container-custom w-full">
            <div className="max-w-lg lg:max-w-xl xl:max-w-2xl lg:pl-6 xl:pl-10">
              ...
              >
                <span className="block text-white text-3xl sm:text-4xl md:text-[3.1rem] lg:text-[3.5rem]">Contemporary Elegance</span>
                <span className="block text-gold text-2xl sm:text-[1.7rem] md:text-[2.5rem] lg:text-[2.8rem] mt-1.5 leading-[1.1]">in Porcelain</span>
              </motion.h1>
        ...
        <div className="container-custom max-w-4xl">
          <FadeIn>
            <p className="text-gray-600 text-base sm:text-lg leading-[1.82]">
              Designed for contemporary living, porcelain countertops combine sleek aesthetics with exceptional durability. Their refined finishes, versatile designs, and impressive resistance to heat, stains, and scratches make them an ideal choice for kitchens, bathrooms, and outdoor spaces. From subtle minimalist tones to striking stone-inspired patterns, porcelain offers a sophisticated surface for every design vision.
            </p>
          </FadeIn>
        </div>
      </section>
        ...
        <div className="container-custom max-w-7xl">
          <FadeIn className="mb-10">
            <h2 className="font-playfair text-2xl sm:text-3xl font-extrabold text-gray-900">
              Contemporary Porcelain Collection
            </h2>
          </FadeIn>
      ...
      <section className="relative py-20 md:py-28 overflow-hidden">
        <div className="absolute inset-0">
          <Image src="/countertops_3.jpg" alt="Porcelain countertop background" fill className="object-cover object-center" sizes="100vw" />
        ...
        <div className="relative z-10 container-custom max-w-3xl text-center px-4">
          <FadeIn>
            ...
            <p className="font-playfair text-gray-900 text-2xl sm:text-3xl md:text-4xl font-extrabold leading-tight mb-6">
              Every project is custom fabricated and professionally installed to deliver seamless craftsmanship and lasting beauty in every porcelain surface.
            </p>
            <Link
              href="/contact"
