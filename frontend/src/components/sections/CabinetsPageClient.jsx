...
import {
  ...
  Package, Layers, PaintBucket, Home,
} from 'lucide-react'
...
const REVIEWS = [
  {
    ...
    rating: 5,
    time: '2 weeks ago',
    text: "The team did an amazing job on our kitchen cabinets. The selection at the showroom was incredible and they helped us find the perfect style for our budget. The installation was fast and professional!",
  },
  {
    name: 'Robert T.',
    ...
    rating: 5,
    time: '1 month ago',
    text: 'We replaced our outdated kitchen cabinets and the transformation is incredible. The showroom had so many options and the staff was very knowledgeable about styles and materials. Highly recommend!',
  },
  {
    name: 'Maria S.',
    location: 'Tampa, FL',
    ...
    rating: 5,
    time: '3 weeks ago',
    text: 'Professional from start to finish. The cabinet installation was precise and the team was courteous and tidy. My new bathroom vanity cabinets are exactly what I envisioned. Great experience!',
  },
  {
    name: 'David L.',
    location: 'Valrico, FL',
    ...
    rating: 5,
    time: '2 months ago',
    text: 'Outstanding experience. We visited the showroom and were able to compare different cabinet styles and finishes side by side. They helped us choose the right cabinets for our budget. The installation was flawless.',
  },
]
...
const DEFAULT_FAQS = [
  {
    question: 'What types of cabinets do you carry?',
    answer:
      'Cabinets & Remodeling Depot carries in-stock and custom-order cabinets for kitchens and bathrooms. We offer base cabinets, wall cabinets, tall/pantry cabinets, bathroom vanities, and specialty cabinetry in a variety of styles and finishes.',
  },
  {
    question: 'Do you offer custom cabinet options?',
    answer:
      'Yes. We offer both in-stock cabinets for fast project turnarounds and custom cabinet options for homeowners who want specific sizes, finishes, or configurations. Visit our Valrico showroom to explore both options.',
  },
  {
    question: 'How long does cabinet installation take?',
    answer:
      'Installation time depends on the scope of the project. A standard kitchen cabinet installation typically takes 1–3 days. Full kitchen remodels that include cabinets, countertops, and flooring may take longer. We provide timelines during your free estimate.',
  },
  {
    question: 'Can you install cabinets with new countertops?',
    answer:
      'Absolutely. Cabinets & Remodeling Depot offers countertop fabrication and installation as well. We can coordinate the entire kitchen or bathroom project — cabinets, countertops, flooring, and more.',
  },
  {
    question: 'What cabinet finishes are available?',
    answer:
      'We carry cabinets in a wide range of finishes including white, off-white, gray, espresso, natural wood tones, and painted custom colors. The best way to compare is to visit our showroom in Valrico, FL.',
  },
  {
    question: 'Do you remove old cabinets?',
    answer:
      'Yes, old cabinet removal can be included in your project scope. Discuss this with our team during your free estimate so we can plan accordingly.',
  },
  {
    question: 'Do you install bathroom vanity cabinets?',
    answer:
      'Yes. We install cabinets for both kitchens and bathrooms, including vanity bases, vanity tops, medicine cabinets, and linen storage. Visit the showroom to explore bathroom cabinet options.',
  },
  {
    question: 'Do you offer free estimates?',
    answer:
      'Yes. Call (813) 651-2333 or visit our Valrico showroom to request a free cabinet estimate.',
  },
]
...
export function CabinetsPageClient() {
  ...
  const { data: page } = usePageContent('cabinets')
  ...
  const heroTitle    = heroSection?.title    || 'Custom Cabinets Tampa Bay Homeowners Trust'
    ...
    <>
      ...
      <section className="relative flex flex-col min-h-[90vh] md:min-h-screen overflow-hidden">
        ...
        <div className="absolute inset-0">
          <Image
            ...
            alt="Custom cabinets background"
            fill
            priority
            ...
            <div className="max-w-xl lg:max-w-2xl">
              ...
              >
                <p className="text-white/90 text-sm sm:text-[0.95rem] leading-relaxed">
                  Looking for beautiful, functional cabinets in Tampa Bay without the long lead times or inflated prices?
                </p>
                <p className="text-white/80 text-sm sm:text-[0.95rem] leading-relaxed">
                  Cabinets &amp; Remodeling Depot helps homeowners upgrade kitchens and bathrooms with in-stock and custom cabinets, expert installation, and wholesale-friendly pricing.
                </p>
              ...
              >
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-y-4 gap-x-3 lg:gap-x-0">
                  {[
                    { Icon: Tag,       title: 'Wholesale Pricing',         sub: 'No Retail Markup'             },
                    { Icon: Package,   title: 'In-Stock Selection',        sub: 'Fast Project Turnaround'      },
              ...
              {[
                {
                  ...
                  desc: 'Kitchen cabinets, bath vanities, pantry, wall & base units',
                },
                {
                  Icon: MapPin,
                ...
                },
                {
                  ...
                  desc: 'In-stock cabinets available for quick project completion',
                },
                {
                  Icon: Tag,
      ...
      <section className="section-padding bg-white">
        <div className="container-custom">
          ...
          >
            <p>
              Cabinets are the foundation of any kitchen or bathroom remodel. They set the style, define the storage, and impact how you use the space every day. Choosing the right cabinets matters — and so does who installs them.
            </p>
            <p>
              At Cabinets &amp; Remodeling Depot, we carry a wide selection of in-stock cabinets for fast project completion, along with custom cabinet options for homeowners who need specific sizes, finishes, or configurations. We help you find the right cabinets for your{' '}
              <strong className="text-gray-900 font-semibold">style</strong>,{' '}
              <strong className="text-gray-900 font-semibold">budget</strong>, and{' '}
              <strong className="text-gray-900 font-semibold">timeline</strong>.
            </p>
            <p>
              Visit our{' '}
              <strong className="text-gray-900 font-semibold">Valrico showroom</strong> to compare cabinet styles, finishes, and configurations in person. Our team understands{' '}
              <strong className="text-gray-900 font-semibold">
                kitchens, bathrooms, countertops, flooring, and full remodeling projects
              </strong>
              , so we can help coordinate the entire project from start to finish.
            </p>
          </FadeIn>

          {/* ── 5 Cabinet type cards ────────────────────────────────────── */}
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4 sm:gap-5">
            {[
              {
                name: 'Base Cabinets',
                src: '/cabinet_img.webp',
                desc: 'The foundation of your kitchen layout. Available in standard and custom widths with a variety of door styles.',
              },
              {
                name: 'Wall Cabinets',
                src: '/Custom-Cabinets-and-Countertops-for-Tampa-2.jpg',
                desc: 'Upper cabinets that maximize vertical storage and frame the kitchen with a clean, finished look.',
              },
              {
                name: 'Pantry & Tall',
                src: '/kitchen_countertops_marble.webp',
                desc: 'Full-height pantry and utility cabinets for maximum storage capacity in kitchens and laundry areas.',
              },
              {
                name: 'Bath Vanities',
                src: '/marble.webp',
                desc: 'Bathroom vanity cabinets in single and double configurations with a wide range of finishes.',
              },
              {
                name: 'Custom Builds',
                src: '/countertop_bg.webp',
                desc: 'Fully custom cabinet configurations built to your exact measurements, style, and storage needs.',
              },
      ...
      {/* ═══════════════════════════════════════════════════════════════════
          CABINETS FOR TAMPA BAY HOMES
      ═══════════════════════════════════════════════════════════════════ */}
      <section className="relative section-padding overflow-hidden">

        <Image
          src="/Custom-Cabinets-and-Countertops-for-Tampa-2.jpg"
          alt="Custom cabinets installed in Tampa Bay home"
          fill
          className="object-cover object-center"
          sizes="100vw"
        />
          ...
          <div className="max-w-xl lg:max-w-2xl">
            <FadeIn>
              <h2 className="text-3xl sm:text-4xl lg:text-[2.6rem] font-bold leading-tight mb-8">
                <span className="text-primary">Best Cabinets</span>{' '}
                <span className="text-gray-900">for Tampa Bay Homes</span>
              </h2>

              <ul className="space-y-5">
                {[
                  'Tampa Bay homes come in all shapes and sizes — from modern new construction to older homes that need updated storage and style. The right cabinets can transform a space and add real value.',
                  'For kitchens, base cabinets and wall cabinets form the core of your layout. Choosing the right door style, finish, and hardware makes a significant difference in the overall look.',
                  'For bathrooms, vanity cabinets set the tone for the entire room. We carry single and double vanity options in a variety of sizes and finishes to match any bathroom style.',
                  'For resale value, updated cabinets are one of the most impactful kitchen and bathroom improvements. Buyers notice cabinet quality immediately.',
                  'For budget-conscious projects, our in-stock cabinet selection offers strong value without the long lead times of fully custom orders.',
                ].map((point, i) => (
      ...
      {/* ═══════════════════════════════════════════════════════════════════
          CABINET STYLE COMPARISON TABLE — desktop only
      ═══════════════════════════════════════════════════════════════════ */}
            ...
            <div className="rounded-2xl border border-gray-200 overflow-hidden shadow-sm">
              <table className="w-full text-sm">
                <thead>
                  <tr className="bg-gray-50 border-b border-gray-200">
                    {['Style', 'Best For', 'Aesthetic', 'Price Range', 'Lead Time'].map((col) => (
                      <th
                        key={col}
                ...
                <tbody>
                  {[
                    {
                      style: 'Shaker',
                      bestFor: 'Most kitchens & bathrooms, timeless look',
                      aesthetic: 'Clean, transitional, versatile',
                      price: 'Mid-range',
                      lead: 'In stock available',
                    },
                    {
                      style: 'Flat Panel',
                      bestFor: 'Modern and contemporary designs',
                      aesthetic: 'Sleek, minimalist, clean lines',
                      price: 'Mid-range',
                      lead: 'In stock available',
                    },
                    {
                      style: 'Raised Panel',
                      bestFor: 'Traditional and classic kitchens',
                      aesthetic: 'Elegant, detailed, formal',
                      price: 'Mid to high',
                      lead: 'In stock & custom',
                    },
                    {
                      style: 'Glass Front',
                      bestFor: 'Display areas, upper wall cabinets',
                      aesthetic: 'Open, decorative, airy feel',
                      price: 'Higher end',
                      lead: 'Custom order',
                    },
                    {
                      style: 'Custom Build',
                      bestFor: 'Unique spaces, specific storage needs',
                      aesthetic: 'Any style, fully personalized',
                      price: 'Varies',
                      lead: 'Custom timeline',
                    },
                  ].map((row, i, arr) => (
                    <tr
                      key={row.style}
                    ...
                    >
                      <td className="px-5 py-5 font-bold text-primary text-sm">{row.style}</td>
                      <td className="px-5 py-5 text-[#4a7fa5] text-sm leading-snug">{row.bestFor}</td>
                      <td className="px-5 py-5 text-[#4a7fa5] text-sm leading-snug">{row.aesthetic}</td>
                      <td className="px-5 py-5 text-[#4a7fa5] text-sm">{row.price}</td>
                      <td className="px-5 py-5 text-[#4a7fa5] text-sm">{row.lead}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
              <div className="px-5 py-4 bg-gray-50 border-t border-gray-100 text-center">
                <p className="text-muted-foreground text-xs sm:text-sm">
                  Still not sure? Visit our Valrico showroom and compare cabinet styles in person before making a decision.
                </p>
              </div>
            </div>
          </FadeIn>
      ...
      <section className="relative section-padding overflow-hidden">
        ...
        <div className="absolute inset-0">
          <Image
            src="/cntrtop_img.jpg"
            alt="Cabinet workshop background"
            fill
            className="object-cover object-center"
            sizes="100vw"
            style={{ opacity: 0.5 }}
        ...
        <div className="relative z-10 container-custom">
          ...
          <div className="grid sm:grid-cols-2 gap-5 sm:gap-6">
            {[
              {
                Icon: Tag,
                title: 'Competitive Pricing on In-Stock Cabinets',
                body: 'Our in-stock cabinet inventory is priced to offer homeowners strong value without long wait times. We work to minimize the retail markup so more of your remodeling budget goes toward the actual project.',
              },
              {
                Icon: MapPin,
                title: 'A Real Local Showroom',
                body: 'Cabinet finishes and door styles look different in person than they do online. At our Valrico showroom, you can compare cabinet styles, finishes, and hardware options before making any decisions.',
              },
              {
                Icon: Settings2,
                title: 'In-Stock & Custom Options',
                body: 'We carry in-stock cabinets for homeowners who need fast turnarounds, and custom cabinet solutions for those who need specific sizes, configurations, or finishes that standard lines do not offer.',
              },
              {
                Icon: Layers,
                title: 'One-Stop Kitchen and Bathroom Remodeling',
                body: 'Cabinets connect directly to countertops, flooring, backsplash, and full remodeling work. We can help coordinate the entire project instead of making you manage multiple contractors.',
              },
              {
                Icon: Wrench,
                title: 'Professional Installation',
                body: 'Even great cabinets can be ruined by poor installation. Proper leveling, alignment, and finishing matter. Our installation team focuses on doing the work correctly from start to finish.',
              },
            ...
            {[
              {
                num: '1',
                Icon: MessageSquare,
                title: 'Consultation & Style Selection',
                desc: 'Call us or visit our Valrico showroom. We help you compare cabinet styles, finishes, and configurations based on your kitchen or bathroom layout, budget, and aesthetic.',
              },
              {
                num: '2',
                Icon: Ruler,
                title: 'Measurement',
                desc: 'We measure your space carefully to ensure the right cabinet sizes, configurations, and any custom modifications needed for a perfect fit.',
              },
              {
                num: '3',
                Icon: Package,
                title: 'Cabinet Preparation',
                desc: 'Your selected cabinets are prepared, checked for quality, and staged for installation. Custom orders are fabricated to your exact specifications.',
              },
              {
                num: '4',
                Icon: Wrench,
                title: 'Installation',
                desc: 'Our installation team installs the cabinets level and plumb, secures them properly, installs hardware, and cleans the area upon completion.',
              },
          ...
          <FadeIn delay={0.5} className="text-center mt-12">
            <p className="text-gray-600 text-sm sm:text-base">
              ...
              <Link href="/contact" className="text-primary font-bold hover:underline">
                request a free cabinet estimate
              </Link>
              .
            </p>
          </FadeIn>
          ...
          <div className="grid md:grid-cols-2 gap-10 lg:gap-14 md:items-stretch">
            ...
            <FadeIn className="flex flex-col justify-center">
              <h2 className="text-3xl sm:text-4xl font-bold leading-tight mb-5">
                <span className="text-primary">Cabinet Installation</span>{' '}
            ...
            {[
              {
                ...
                body: 'Wipe cabinet surfaces with a damp cloth and mild soap. Avoid excessive water near the edges and hinges to prevent swelling or damage over time.',
              },
              {
                Icon: AlertCircle,
                title: 'Avoid Harsh Cleaners',
                body: 'Do not use abrasive cleaners, steel wool, or solvent-based products on cabinet finishes. These can strip the finish or cause discoloration.',
              },
              {
                Icon: Droplets,
                title: 'Protect from Moisture',
                body: 'Keep cabinets near sinks and dishwashers dry. Wipe up spills and splashes promptly. Use exhaust fans to reduce humidity in kitchens and bathrooms.',
              },
              {
                Icon: Flame,
                title: 'Keep Away from Direct Heat',
                body: 'Avoid placing heat-generating appliances directly against cabinet surfaces. Use heat shields or ensure adequate clearance near stovetops and ovens.',
              },
              {
                Icon: ShieldCheck,
                title: 'Check Hinges & Hardware',
                body: 'Periodically check door hinges and drawer slides for proper alignment. Most hinges are adjustable and can be tuned for a perfect fit.',
              },
              {
                Icon: Clock,
                title: 'Touch Up Promptly',
                body: 'Address chips, scratches, or finish damage quickly. Small touch-ups are much easier to manage than letting damage spread over time.',
              },
            ...
            <FadeIn x={-30} y={0} className="relative rounded-2xl overflow-hidden min-h-[380px] sm:min-h-[460px] md:min-h-[500px]">
              ...
              <div className="absolute inset-0">
                <Image
                  ...
                  alt="Professional cabinet installation expert"
                  fill
        ...
        <div className="container-custom max-w-4xl">
          <FadeIn className="text-center mb-12">
            ...
            <p className="text-muted-foreground text-base sm:text-lg max-w-2xl mx-auto">
              Have questions about cabinet installation in Tampa? We&apos;ve got answers.
            </p>
          </FadeIn>
          ...
          <div className="grid md:grid-cols-2 gap-10 lg:gap-16 items-start">
            ...
            <FadeIn x={-30} y={0}>
              <h2 className="text-3xl sm:text-4xl lg:text-[2.6rem] font-bold leading-tight mb-5">
                Get Your{' '}
                <span className="text-primary">Free Cabinet Estimate</span>{' '}
                Today
              </h2>
              <p className="text-gray-600 text-sm sm:text-base leading-relaxed mb-2">
                If you are planning a kitchen upgrade, bathroom renovation, or any project that requires new cabinets, Cabinets &amp; Remodeling Depot can help you choose the right style and get the project done correctly.
              </p>
              <p className="text-gray-600 text-sm sm:text-base leading-relaxed mb-8">
                Visit our Valrico showroom to compare cabinet styles and finishes in person — or call us to schedule a free estimate.
              </p>
            ...
            <FadeIn delay={0.2} x={30} y={0}>
              <div className="bg-white rounded-2xl border border-gray-200 shadow-md p-6 md:p-8">
                ...
                <ConsultationForm serviceName="Custom Cabinets" />
              </div>
            </FadeIn>
