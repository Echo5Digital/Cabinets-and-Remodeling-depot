  ...
  return (
    <>
      ...
      <section className="relative flex flex-col min-h-[90vh] md:min-h-screen overflow-hidden">
        <div className="absolute inset-0">
          <Image
            ...
            alt="Glass-front kitchen cabinets hero"
            fill
            priority
        ...
        <div className="relative z-10 flex-1 flex items-center py-20 sm:py-24 md:py-32">
          <div className="container-custom w-full">
            <div className="max-w-lg lg:max-w-xl xl:max-w-2xl lg:pl-6 xl:pl-10">
              ...
              >
                <span className="block text-white text-3xl sm:text-4xl md:text-[3.1rem] lg:text-[3.5rem]">Refined Display with</span>
                <span className="block text-gold text-2xl sm:text-[1.7rem] md:text-[2.5rem] lg:text-[2.8rem] mt-1.5 leading-[1.1]">Glass-Front Cabinets</span>
              </motion.h1>
        ...
        <div className="container-custom max-w-4xl">
          <FadeIn>
            <p className="text-gray-600 text-base sm:text-lg leading-[1.82]">
              Elegant and inviting, Glass-Front cabinets add depth, light, and sophistication to your kitchen. Designed to showcase fine dinnerware, decorative pieces, or curated collections, these cabinets create a sense of openness while enhancing the overall aesthetic of your space. Available with a variety of glass styles, frame designs, and finishes, they offer the perfect balance of functionality and timeless beauty.
            </p>
          </FadeIn>
        </div>
      </section>
      ...
      <section className="relative py-20 md:py-28 overflow-hidden">
        <div className="absolute inset-0">
          <Image src="/cabinet_img.webp" alt="Glass-front cabinets background" fill className="object-cover object-center" sizes="100vw" />
        ...
        <div className="relative z-10 container-custom max-w-3xl text-center px-4">
          <FadeIn>
            ...
            <p className="font-playfair text-gray-900 text-2xl sm:text-3xl md:text-4xl font-extrabold leading-tight mb-6">
              Every cabinet is thoughtfully crafted and professionally installed to create a seamless blend of elegance, functionality, and exceptional craftsmanship.
            </p>
            <Link
              href="/contact"
