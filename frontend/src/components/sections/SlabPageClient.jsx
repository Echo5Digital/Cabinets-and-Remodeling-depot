...
const IMAGES = [
  ...
  { src: '/cabinet-slab1.webp', alt: 'Flat panel cabinet kitchen installation' },
  { src: '/kitchencabinet4.jpg', alt: 'Slab cabinets in kitchen' },
  { src: '/cabinet-slab2.webp', alt: 'Modern flat panel cabinet design' },
  { src: '/cabinet-slab3.webp', alt: 'Slab style cabinet detail' },
  { src: '/cabinet-slab4.webp', alt: 'Custom slab cabinet installation Tampa' },
]
  ...
  return (
    <>
      ...
      <section className="relative flex flex-col min-h-[55vh] md:min-h-[65vh] overflow-hidden">
        <div className="absolute inset-0">
          <Image
            ...
            alt="Slab flat panel kitchen cabinets hero"
            fill
            priority
        ...
        <div className="relative z-10 flex-1 flex items-center py-14 sm:py-16 md:py-20">
          <div className="container-custom w-full">
            <div className="max-w-lg lg:max-w-xl xl:max-w-2xl lg:pl-6 xl:pl-10">
              ...
              >
                <span className="block text-white text-3xl sm:text-4xl md:text-[3.1rem] lg:text-[3.5rem]">Sleek Sophistication with</span>
                <span className="block text-gold text-2xl sm:text-[1.7rem] md:text-[2.5rem] lg:text-[2.8rem] mt-1.5 leading-[1.1]">Slab &amp; Flat Panel Cabinets</span>
              </motion.h1>
        ...
        <div className="container-custom max-w-4xl">
          <FadeIn>
            <p className="text-gray-600 text-base sm:text-lg leading-[1.82]">
              Defined by smooth surfaces and clean, uninterrupted lines, Slab and Flat Panel cabinets embody the essence of modern design. Their minimalist aesthetic creates a bright, open feel while complementing contemporary, Scandinavian, and European-inspired interiors. Available in a variety of finishes, textures, and colors, these cabinets offer a refined look that balances simplicity with lasting elegance.
            </p>
          </FadeIn>
        </div>
      </section>
      ...
      <section className="relative py-20 md:py-28 overflow-hidden">
        <div className="absolute inset-0">
          <Image src="/cabinet_img.webp" alt="Slab cabinets background" fill className="object-cover object-center" sizes="100vw" />
        ...
        <div className="relative z-10 container-custom max-w-3xl text-center px-4">
          <FadeIn>
            ...
            <p className="font-playfair text-gray-900 text-2xl sm:text-3xl md:text-4xl font-extrabold leading-tight mb-6">
              Every cabinet is thoughtfully crafted and professionally installed to deliver precision, contemporary style, and a seamless finish tailored to your space.
            </p>
            <Link
              href="/contact"
