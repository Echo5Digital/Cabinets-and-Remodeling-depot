...
const PAGE_DEFAULT_SECTIONS = {
  ...
  services: [
    ...
    },
    {
      ...
      heading: 'What We Do',
      items: [
        { icon: 'ChefHat', title: 'Kitchen Remodeling', description: 'Complete kitchen transformations from cabinets to countertops.', link: '/kitchen-remodeling-tampa', image: '' },
        { icon: 'Droplets', title: 'Bathroom Remodeling', description: 'Luxury bathroom renovations and spa-style upgrades.', link: '/bathroom-remodeling-tampa', image: '' },
        { icon: 'Layout', title: 'Custom Cabinets', description: 'Handcrafted cabinetry built to your exact specifications.', link: '/kitchen-cabinets-tampa', image: '' },
        { icon: 'Layers', title: 'Countertops', description: 'Quartz and granite countertops for kitchens and bathrooms.', link: '/countertops-tampa', image: '' },
        { icon: 'Grid3X3', title: 'Flooring', description: 'Hardwood, tile, vinyl, and luxury flooring installation.', link: '/flooring-in-tampa', image: '' },
        { icon: 'PencilRuler', title: 'Design Consultation', description: 'Professional design guidance for your remodeling project.', link: '/contact', image: '' },
      ],
    },
    {
      id: 'services-cta',
  ...
  'countertops-tampa': [
    ...
    },
    {
      ...
      items: [
        { title: 'Quartz Countertops', description: 'Engineered stone combining natural quartz with resins for a non-porous, low-maintenance surface. Perfect for busy Tampa Bay kitchens.', image: '/quartz-countertops.jpg', link: '/contact' },
        { title: 'Granite Countertops', description: 'Natural stone with unique veining patterns and exceptional durability. Heat resistant and adds timeless beauty to any kitchen.', image: '/granite-countertops.jpg', link: '/contact' },
        { title: 'Quartzite Countertops', description: 'Natural stone harder than granite with the appearance of marble. Outstanding durability and unique character for luxury kitchens.', image: '/quartzite-countertops.jpg', link: '/contact' },
        { title: 'Marble Countertops', description: 'Timeless luxury with distinctive veining. Perfect for bathrooms, baking areas, and statement kitchen islands.', image: '/marble-countertops.jpg', link: '/contact' },
        { title: 'Porcelain Countertops', description: 'Ultra-durable, heat resistant, and virtually maintenance-free. Available in large format slabs for a seamless modern look.', image: '/porcelain-countertops.jpg', link: '/contact' },
      ],
    },
    {
      id: 'ct-why-choose',
      ...
      items: [
        { title: 'Wholesale Pricing', description: 'We import directly, cutting out the middleman to bring you better pricing on premium materials.', icon: 'Tag' },
        { title: 'Custom Fabrication', description: 'In-house fabrication ensures perfect fit, precise cuts, and superior quality control.', icon: 'Settings2' },
        { title: 'Professional Installation', description: 'Expert installation team handles everything from template measurement to final polishing.', icon: 'Wrench' },
        { title: 'Local Showroom', description: 'Compare materials, colors, and finishes in person at our Valrico showroom.', icon: 'Building2' },
        { title: 'Full Remodeling Support', description: 'Coordinate countertops with cabinets, flooring, and full kitchen or bathroom remodels.', icon: 'Home' },
        { title: 'Free Estimates', description: 'Get a free estimate with no obligation. We work with every budget.', icon: 'Calendar' },
      ],
    },
    {
      id: 'ct-process',
      ...
      steps: [
        { step: '01', title: 'Consultation', description: 'Visit our showroom or call to discuss your project, budget, and material preferences.' },
        { step: '02', title: 'Measurement', description: 'Our team takes precise measurements to ensure a perfect fit for your countertop.' },
        { step: '03', title: 'Fabrication', description: 'Custom fabrication of your countertop with precise cuts, edge profiles, and sink cutouts.' },
        { step: '04', title: 'Installation', description: 'Professional installation by our experienced team, leaving your space clean and polished.' },
      ],
    },
    {
      id: 'ct-areas',
      ...
      areas: ['Tampa', 'Brandon', 'Riverview', 'Valrico', 'Lithia', 'FishHawk', 'Bloomingdale', 'South Tampa', 'Westchase', 'Carrollwood', 'Temple Terrace', 'Wesley Chapel', 'Lutz'],
    },
    {
      id: 'ct-faq',
      type: 'faq',
      ...
      items: [
        { question: 'How much do countertops cost in Tampa Bay?', answer: 'Countertop pricing depends on the material, square footage, edge style, sink cutouts, and installation needs. The best way to get accurate pricing is to visit the showroom or schedule a free estimate.' },
