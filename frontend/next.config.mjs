...
const nextConfig = {
  ...
  async redirects() {
    return [
      ...
      { source: '/kitchen-remodeling', destination: '/kitchen-remodel-tampa', permanent: true },
      { source: '/kitchen-remodeling-tampa', destination: '/kitchen-remodel-tampa', permanent: true },
