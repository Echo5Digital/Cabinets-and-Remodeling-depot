...
export function getDefaultContent(slug) {
  const defaults = {
      ...
      sections: [
        {
          id: 'about-hero',
          type: 'hero',
          title: 'Building Beautiful Homes Since 2005',
          subtitle: 'About Cabinets & Remodeling Depot',
          backgroundImage: '/kitchen-remodeling-hero.webp',
          ctaText: 'Visit Our Showroom',
          ctaLink: '/contact',
          secondaryCtaText: 'Schedule a Consultation',
          secondaryCtaLink: '/contact',
          description: 'For over two decades, Cabinets & Remodeling Depot has helped homeowners across Tampa Bay transform their kitchens, bathrooms, and living spaces with exceptional craftsmanship, premium materials, and personalized remodeling solutions.',
        },
        {
          id: 'about-story',
          type: 'text',
          heading: 'A Passion for Quality. A Commitment to You.',
          body: "Founded in 2005, Cabinets & Remodeling Depot began with a simple vision: to provide homeowners with high-quality cabinetry and remodeling solutions backed by honest service and expert craftsmanship.\n\nWhat started as a cabinet-focused business has grown into a trusted, full-service remodeling company serving homeowners throughout Tampa Bay. Over the years, we've expanded our expertise to include kitchen remodeling, bathroom remodeling, custom cabinetry, countertops, flooring, and complete renovation solutions—all under one roof.\n\nWe believe remodeling should be an exciting experience, not a stressful one. That's why our team works closely with every client, guiding them from the initial consultation and design phase to material selection and professional installation. Every detail matters, and every project is completed with the same level of care and attention we would give our own homes.\n\nWhether you're updating a single room or transforming your entire home, our goal remains the same: delivering beautiful spaces built to last.",
          image: '/gti.webp',
          layout: 'split',
        },
        {
          ...
          items: [
            { title: '20+ Years of Experience', description: "Since 2005, we've proudly served Tampa Bay homeowners with trusted remodeling expertise, quality workmanship, and dependable service.", icon: 'Calendar' },
            { title: 'One-Stop Remodeling Solution', description: 'From cabinets and countertops to flooring and complete renovations, everything you need for your remodeling project is available in one convenient showroom.', icon: 'Store' },
            { title: 'Quality Products You Can Trust', description: 'We carefully select premium materials and products designed for durability, beauty, and long-term performance.', icon: 'ShieldCheck' },
            { title: 'Expert Design & Installation', description: 'Our experienced professionals combine thoughtful design with precise installation to ensure exceptional results from start to finish.', icon: 'Wrench' },
            { title: 'Customer-First Approach', description: 'Every remodeling project begins by listening to your ideas, understanding your goals, and creating solutions tailored to your lifestyle.', icon: 'Users' },
            { title: 'Competitive Pricing & Great Value', description: 'We believe exceptional remodeling should offer lasting value. Our team provides honest recommendations and quality solutions to fit a variety of budgets.', icon: 'DollarSign' },
          ],
        },
        {
          id: 'about-process',
          ...
          heading: 'Our Process',
          steps: [
            { step: '1', title: 'Consult', description: 'We begin with a personalized consultation to understand your vision, discuss your goals, and evaluate your space.' },
            { step: '2', title: 'Design', description: "Our design specialists help you select cabinetry, countertops, flooring, finishes, and layouts that complement your home's style and your daily needs." },
            { step: '3', title: 'Plan', description: 'Once your selections are finalized, we develop a detailed project plan, timeline, and installation schedule to ensure a smooth remodeling experience.' },
            { step: '4', title: 'Build', description: 'Our skilled craftsmen complete every phase of your project with precision, professionalism, and close attention to detail.' },
            { step: '5', title: 'Enjoy', description: "The final result is a beautifully finished space designed to enhance your home's comfort, functionality, and value for years to come." },
          ],
        },
        {
          id: 'about-showroom',
          ...
          body: "Experience the quality of our products in person. Visit our Valrico showroom to explore an extensive selection of kitchen cabinets, bathroom vanities, countertops, flooring, hardware, and design inspiration. Our knowledgeable team is here to answer your questions, help you compare materials, and guide you toward the perfect solution for your home.\n\nWhether you're planning a complete remodel or simply gathering ideas, our showroom is the perfect place to begin your journey.",
          bgImage: '/cabinet-instock.webp',
          address: '106 S St Cloud Ave\nValrico, FL 33594',
          phone: '(813) 651-2333',
          email: 'sales@cabinetsandremodelingdepot.com',
        ...
        },
        {
          ...
          body: "Your dream home starts with the right team. Whether you're planning a kitchen remodel, bathroom renovation, new flooring, or custom cabinetry, Cabinets & Remodeling Depot is here to bring your vision to life with expert craftsmanship and personalized service.",
          bgImage: '/kitchen_cabinet_remodeling-01.webp',
          buttonText: 'Schedule a Consultation',
          buttonLink: '/contact',
          secondaryButtonText: 'Call Us Today',
          secondaryButtonLink: 'tel:+18136512333',
        },
      ],
      seo: {
      ...
      sections: [
        {
          ...
          subtitle: 'Your feedback helps Tampa Bay homeowners make confident remodeling decisions.',
          backgroundImage: '',
      ...
      sections: [
        {
          id: 'renovations-hero',
          type: 'hero',
          title: 'Home Renovations Tampa Bay',
          subtitle: 'Complete home renovation solutions from kitchens and bathrooms to flooring and beyond.',
          backgroundImage: '',
          ctaText: 'Get a Free Estimate',
          ctaLink: '/contact',
        },
      ...
      sections: [
        {
          id: 'cab-types-hero',
          type: 'hero',
          title: 'Kitchen Cabinet Types',
          subtitle: 'Explore the different types of kitchen cabinets available at Cabinets & Remodeling Depot.',
          backgroundImage: '',
          ctaText: 'Visit Our Showroom',
          ctaLink: '/contact',
        },
    ...
    'contemporary-style-cabinets': {
      sections: [
        {
          id: 'contemporary-hero',
          type: 'hero',
          title: 'Contemporary Style Cabinets',
          subtitle: 'Clean lines, minimalist design, and modern finishes for today\'s kitchens.',
          backgroundImage: '',
          ctaText: 'Visit Our Showroom',
          ctaLink: '/contact',
        },
      ...
      sections: [
        {
          id: 'glass-front-hero',
          type: 'hero',
          title: 'Glass-Front Kitchen Cabinets',
          subtitle: 'Open, airy, and elegant — glass-front cabinets add style and depth to any kitchen.',
          backgroundImage: '',
          ctaText: 'Visit Our Showroom',
          ctaLink: '/contact',
        },
      ...
      sections: [
        {
          ...
          subtitle: 'Bold, raw, and modern — industrial style cabinets bring character to any kitchen.',
          backgroundImage: '',
          ctaText: 'Visit Our Showroom',
          ctaLink: '/contact',
        },
      ...
      sections: [
        {
          ...
          subtitle: 'Sleek, functional, and sophisticated — modern cabinets for the contemporary home.',
          backgroundImage: '',
          ctaText: 'Visit Our Showroom',
          ctaLink: '/contact',
        },
    ...
    'raised-panel-kitchen-cabinets': {
      sections: [
        {
          id: 'raised-panel-hero',
          type: 'hero',
          title: 'Raised Panel Kitchen Cabinets',
          subtitle: 'Classic raised panel cabinetry that brings timeless elegance to Tampa Bay kitchens.',
          backgroundImage: '',
          ctaText: 'Visit Our Showroom',
          ctaLink: '/contact',
        },
      ...
      sections: [
        {
          ...
          subtitle: 'Warm, natural, and full of character — rustic cabinets bring charm to any kitchen.',
          backgroundImage: '',
          ctaText: 'Visit Our Showroom',
          ctaLink: '/contact',
        },
    ...
    'shaker-kitchen-cabinets': {
      sections: [
        {
          id: 'shaker-kitchen-hero',
          type: 'hero',
          title: 'Shaker Kitchen Cabinets',
          subtitle: 'The most popular cabinet style in Tampa Bay — timeless, versatile, and built to last.',
          backgroundImage: '',
          ctaText: 'Visit Our Showroom',
          ctaLink: '/contact',
        },
    ...
    'shaker-style-cabinets': {
      sections: [
        {
          id: 'shaker-style-hero',
          type: 'hero',
          title: 'Shaker Style Cabinets',
          subtitle: 'Classic shaker style cabinets — clean lines and versatile design for every home.',
          backgroundImage: '',
          ctaText: 'Visit Our Showroom',
          ctaLink: '/contact',
        },
      ...
      sections: [
        {
          id: 'slab-hero',
          type: 'hero',
          title: 'Slab Kitchen Cabinets',
          subtitle: 'Flat-panel, handle-free, and ultra-modern — slab cabinets for the contemporary kitchen.',
          backgroundImage: '',
          ctaText: 'Visit Our Showroom',
          ctaLink: '/contact',
        },
      ...
      sections: [
        {
          ...
          subtitle: 'Classic craftsmanship and elegant detailing for the timeless kitchen.',
          backgroundImage: '',
          ctaText: 'Visit Our Showroom',
          ctaLink: '/contact',
        },
    ...
    'transitional-style-cabinets': {
      sections: [
        {
          id: 'transitional-hero',
          type: 'hero',
          title: 'Transitional Style Cabinets',
          subtitle: 'The perfect blend of traditional and contemporary — transitional cabinets suit any home.',
          backgroundImage: '',
          ctaText: 'Visit Our Showroom',
          ctaLink: '/contact',
        },
      ...
      sections: [
        {
          ...
          subtitle: 'Explore a wide selection of bathroom vanities at our Valrico showroom.',
          backgroundImage: '',
          ctaText: 'Visit Our Showroom',
          ctaLink: '/contact',
        },
    ...
    // ── COUNTERTOP MATERIAL PAGES ─────────────────────────────────────────────
    'granite-countertops': {
      sections: [
        {
          id: 'granite-hero',
          type: 'hero',
          title: 'Granite Countertops Tampa Bay',
          subtitle: 'Natural stone beauty with exceptional durability. Explore our granite countertop selection.',
          backgroundImage: '/granite.webp',
          ctaText: 'Get a Free Estimate',
          ctaLink: '/contact',
        },
      ],
      ...
      sections: [
        {
          id: 'marble-hero',
          type: 'hero',
          title: 'Marble Countertops Tampa Bay',
          subtitle: 'Timeless elegance and luxury — marble countertops for kitchens and bathrooms.',
          backgroundImage: '/marble.webp',
          ctaText: 'Get a Free Estimate',
          ctaLink: '/contact',
        },
      ],
      ...
      sections: [
        {
          id: 'porcelain-hero',
          type: 'hero',
          title: 'Porcelain Countertops Tampa Bay',
          subtitle: 'Ultra-durable and heat-resistant — porcelain countertops for indoor and outdoor kitchens.',
          backgroundImage: '/porcelain.webp',
          ctaText: 'Get a Free Estimate',
          ctaLink: '/contact',
        },
      ],
      ...
      sections: [
        {
          id: 'quartz-hero',
          type: 'hero',
          title: 'Quartz Countertops Tampa Bay',
          subtitle: 'Low-maintenance, non-porous, and beautiful — the most popular countertop choice in Tampa Bay.',
          backgroundImage: '/quartz.webp',
          ctaText: 'Get a Free Estimate',
          ctaLink: '/contact',
        },
      ],
      ...
      sections: [
        {
          id: 'quartzite-hero',
          type: 'hero',
          title: 'Quartzite Countertops Tampa Bay',
          subtitle: 'Marble-like beauty with the strength of natural stone — quartzite countertops for Tampa Bay homes.',
          backgroundImage: '/quartzite.webp',
          ctaText: 'Get a Free Estimate',
          ctaLink: '/contact',
        },
      ],
      ...
      sections: [
        {
          id: 'faucets-hero',
          type: 'hero',
          title: 'Faucets in Tampa',
          subtitle: 'Kitchen and bathroom faucets to complement your remodeling project.',
          backgroundImage: '',
          ctaText: 'Visit Our Showroom',
          ctaLink: '/contact',
        },
